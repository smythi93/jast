...
class JavaParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by JavaParser#statementStart.
    def visitStatementStart(self, ctx: JavaParser.StatementStartContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#expressionStart.
    ...
    # Visit a parse tree produced by JavaParser#dim.
    def visitDim(self, ctx: JavaParser.DimContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by JavaParser#annotationConstantDeclaration.
    def visitAnnotationConstantDeclaration(
        self, ctx: JavaParser.AnnotationConstantDeclarationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#annotationMethodDeclaration.
    ...
    # Visit a parse tree produced by JavaParser#typeExpression.
    def visitTypeExpression(self, ctx: JavaParser.TypeExpressionContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by JavaParser#ExplicitGenericInvocationExpression.
    def visitExplicitGenericInvocationExpression(
        self, ctx: JavaParser.ExplicitGenericInvocationExpressionContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#ThisExpression.
    def visitThisExpression(self, ctx: JavaParser.ThisExpressionContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by JavaParser#ParExpr.
    def visitParExpr(self, ctx: JavaParser.ParExprContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#LiteralExpression.
    def visitLiteralExpression(self, ctx: JavaParser.LiteralExpressionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#ClassExpression.
    def visitClassExpression(self, ctx: JavaParser.ClassExpressionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#SuperExpression.
    def visitSuperExpression(self, ctx: JavaParser.SuperExpressionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#ArrayAccessExpression.
    def visitArrayAccessExpression(self, ctx: JavaParser.ArrayAccessExpressionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#IdentifierExpression.
    def visitIdentifierExpression(self, ctx: JavaParser.IdentifierExpressionContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by JavaParser#objectCreator.
    def visitObjectCreator(self, ctx: JavaParser.ObjectCreatorContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by JavaParser#arrayCreator.
    def visitArrayCreator(self, ctx: JavaParser.ArrayCreatorContext):
        return self.visitChildren(ctx)
