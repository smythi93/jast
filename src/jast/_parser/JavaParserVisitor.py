...
class JavaParserVisitor(ParseTreeVisitor):
    ...
    def visitUnqualifiedMethodIdentifier(
        self, ctx: JavaParser.UnqualifiedMethodIdentifierContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#contextualKeyword.
    def visitContextualKeyword(self, ctx: JavaParser.ContextualKeywordContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#contextualKeywordMinusForTypeIdentifier.
    def visitContextualKeywordMinusForTypeIdentifier(
        self, ctx: JavaParser.ContextualKeywordMinusForTypeIdentifierContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#contextualKeywordMinusForUnqualifiedMethodIdentifier.
    def visitContextualKeywordMinusForUnqualifiedMethodIdentifier(
        self,
        ctx: JavaParser.ContextualKeywordMinusForUnqualifiedMethodIdentifierContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitSingleTypeImportDeclaration(
        self, ctx: JavaParser.SingleTypeImportDeclarationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#typeImportOnDemandDeclaration.
    def visitTypeImportOnDemandDeclaration(
        self, ctx: JavaParser.TypeImportOnDemandDeclarationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#singleStaticImportDeclaration.
    def visitSingleStaticImportDeclaration(
        self, ctx: JavaParser.SingleStaticImportDeclarationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#staticImportOnDemandDeclaration.
    def visitStaticImportOnDemandDeclaration(
    ...
    def visitNormalClassDeclaration(
        self, ctx: JavaParser.NormalClassDeclarationContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitClassMemberDeclaration(
        self, ctx: JavaParser.ClassMemberDeclarationContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitVariableDeclaratorList(
        self, ctx: JavaParser.VariableDeclaratorListContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitUnannClassOrInterfaceType(
        self, ctx: JavaParser.UnannClassOrInterfaceTypeContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitVariableArityParameter(
        self, ctx: JavaParser.VariableArityParameterContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitExplicitConstructorInvocation(
        self, ctx: JavaParser.ExplicitConstructorInvocationContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitVariableArityRecordComponent(
        self, ctx: JavaParser.VariableArityRecordComponentContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#recordComponentModifier.
    def visitRecordComponentModifier(
        self, ctx: JavaParser.RecordComponentModifierContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitNormalInterfaceDeclaration(
        self, ctx: JavaParser.NormalInterfaceDeclarationContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitAnnotationInterfaceDeclaration(
    ...
    def visitAnnotationInterfaceBody(
        self, ctx: JavaParser.AnnotationInterfaceBodyContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#annotationInterfaceMemberDeclaration.
    def visitAnnotationInterfaceMemberDeclaration(
        self, ctx: JavaParser.AnnotationInterfaceMemberDeclarationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#annotationInterfaceElementDeclaration.
    def visitAnnotationInterfaceElementDeclaration(
        self, ctx: JavaParser.AnnotationInterfaceElementDeclarationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#annotationInterfaceElementModifier.
    def visitAnnotationInterfaceElementModifier(
        self, ctx: JavaParser.AnnotationInterfaceElementModifierContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitSingleElementAnnotation(
        self, ctx: JavaParser.SingleElementAnnotationContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitVariableInitializerList(
        self, ctx: JavaParser.VariableInitializerListContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitLocalClassOrInterfaceDeclaration(
        self, ctx: JavaParser.LocalClassOrInterfaceDeclarationContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitLocalVariableDeclarationStatement(
        self, ctx: JavaParser.LocalVariableDeclarationStatementContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitStatementWithoutTrailingSubstatement(
        self, ctx: JavaParser.StatementWithoutTrailingSubstatementContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitLabeledStatementNoShortIf(
        self, ctx: JavaParser.LabeledStatementNoShortIfContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitIfThenElseStatementNoShortIf(
        self, ctx: JavaParser.IfThenElseStatementNoShortIfContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitWhileStatementNoShortIf(
        self, ctx: JavaParser.WhileStatementNoShortIfContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitBasicForStatementNoShortIf(
        self, ctx: JavaParser.BasicForStatementNoShortIfContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitStatementExpressionList(
    ...
    def visitEnhancedForStatementNoShortIf(
        self, ctx: JavaParser.EnhancedForStatementNoShortIfContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitTryWithResourcesStatement(
        self, ctx: JavaParser.TryWithResourcesStatementContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitClassInstanceCreationExpression(
        self, ctx: JavaParser.ClassInstanceCreationExpressionContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitUnqualifiedClassInstanceCreationExpression(
        self, ctx: JavaParser.UnqualifiedClassInstanceCreationExpressionContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#classOrInterfaceTypeToInstantiate.
    def visitClassOrInterfaceTypeToInstantiate(
    ...
    def visitArrayCreationExpression(
        self, ctx: JavaParser.ArrayCreationExpressionContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitArrayCreationExpressionWithInitializer(
        self, ctx: JavaParser.ArrayCreationExpressionWithInitializerContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitPostIncrementExpression(
        self, ctx: JavaParser.PostIncrementExpressionContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#postDecrementExpression.
    def visitPostDecrementExpression(
        self, ctx: JavaParser.PostDecrementExpressionContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitPreIncrementExpression(
        self, ctx: JavaParser.PreIncrementExpressionContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#preDecrementExpression.
    def visitPreDecrementExpression(
        self, ctx: JavaParser.PreDecrementExpressionContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#unaryExpressionNotPlusMinus.
    def visitUnaryExpressionNotPlusMinus(
        self, ctx: JavaParser.UnaryExpressionNotPlusMinusContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitConditionalAndExpression(
        self, ctx: JavaParser.ConditionalAndExpressionContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#conditionalOrExpression.
    def visitConditionalOrExpression(
        self, ctx: JavaParser.ConditionalOrExpressionContext
    ):
        return self.visitChildren(ctx)
