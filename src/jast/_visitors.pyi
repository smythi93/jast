...
class JNodeVisitor:
    ...
    # Literals
    def visit_IntegerLiteral(self, node: jast.IntLiteral): ...
    ...
    def visit_ElementValueArrayInitializer(self, node: jast.elementarrayinit): ...
    ...
    def visit_TypeArguments(self, node: jast.typeargs): ...
    ...
    def visit_TypeParameter(self, node: jast.typeparam): ...
    def visit_TypeParameters(self, node: jast.typeparams): ...
    ...
    def visit_Mul(self, node: jast.Mult): ...
    ...
    def visit_Assignment(self, node: jast.Assign): ...
    ...
    def visit_PostUnaryOp(self, node: jast.PostOp): ...

    def visit_SwitchExpr(self, node: jast.SwitchExp): ...
    def visit_Reference(self, node: jast.Reference): ...
    def visit_Call(self, node: jast.Call): ...
    def visit_Member(self, node: jast.Member): ...
    def visit_ArrayAccess(self, node: jast.Subscript): ...
    ...
    def visit_Class(self, node: jast.ClassExpr): ...
    ...
    def visit_ExprCase(self, node: jast.ExpCase): ...
    def visit_ExprDefault(self, node: jast.ExpDefault): ...
    def visit_SwitchExprRule(self, node: jast.switchexprule): ...

    # Arrays
    def visit_ArrayInitializer(self, node: jast.arrayinit): ...

    # Parameters
    def visit_ReceiverParameter(self, node: jast.receiver): ...
    def visit_Parameter(self, node: jast.param): ...
    def visit_VariableArityParameter(self, node: jast.arity): ...
    def visit_FormalParameters(self, node: jast.params): ...

    # Statements
    def visit_LocalClassDeclaration(self, node: jast.LocalClass): ...
    def visit_LocalInterfaceDeclaration(self, node: jast.LocalInterface): ...
    def visit_LocalRecordDeclaration(self, node: jast.LocalRecord): ...
    def visit_LocalVariableDeclaration(self, node: jast.LocalVariable): ...
    ...
    def visit_CatchClause(self, node: jast.catch): ...
    def visit_Resource(self, node: jast.resource): ...

    # Declarations
    def visit_PackageDeclaration(self, node: jast.Package): ...
    def visit_ImportDeclaration(self, node: jast.Import): ...
    def visit_EmptyDeclaration(self, node: jast.EmptyDecl): ...
    def visit_ModuleDeclaration(self, node: jast.Module): ...
    def visit_FieldDeclaration(self, node: jast.Field): ...
    def visit_MethodDeclaration(self, node: jast.Method): ...
    def visit_AnnotationMethodDeclaration(self, node: jast.AnnotationMethod): ...
    def visit_Initializer(self, node: jast.Initializer): ...
    def visit_ConstructorDeclaration(self, node: jast.Constructor): ...
    def visit_CompactConstructorDeclaration(self, node: jast.CompactConstructorDeclaration): ...
    def visit_InterfaceDeclaration(self, node: jast.Interface): ...
    def visit_AnnotationDeclaration(self, node: jast.AnnotationDecl): ...
    def visit_ClassDeclaration(self, node: jast.Class): ...
    def visit_EnumDeclaration(self, node: jast.Enum): ...
    def visit_RecordDeclaration(self, node: jast.Record): ...


    # Module Directives
    def visit_RequiresDirective(self, node: jast.Requires): ...
    def visit_ExportsDirective(self, node: jast.Exports): ...
    def visit_OpensDirective(self, node: jast.Opens): ...
    def visit_UsesDirective(self, node: jast.Uses): ...
    def visit_ProvidesDirective(self, node: jast.Provides): ...

    # Variables
    def visit_VariableDeclarator(self, node: jast.declarator): ...
    ...
    # Compilation Units
    def visit_OrdinaryCompilationUnit(self, node: jast.CompilationUnit): ...
    def visit_ModularCompilationUnit(self, node: jast.ModularUnit): ...
