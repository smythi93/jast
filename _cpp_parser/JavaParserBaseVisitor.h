...
public:
  ...
  virtual std::any visitDeclarationStart(JavaParser::DeclarationStartContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitStatementStart(JavaParser::StatementStartContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitExpressionStart(JavaParser::ExpressionStartContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitDirectiveStart(JavaParser::DirectiveStartContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitOrdinaryCompilationUnit(JavaParser::OrdinaryCompilationUnitContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitModularCompilationUnit(JavaParser::ModularCompilationUnitContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitClassExtends(JavaParser::ClassExtendsContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitClassImplements(JavaParser::ClassImplementsContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitClassPermits(JavaParser::ClassPermitsContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitDim(JavaParser::DimContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitCoit(JavaParser::CoitContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitAnnotationConstantDeclaration(JavaParser::AnnotationConstantDeclarationContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAnnotationMethodDeclaration(JavaParser::AnnotationMethodDeclarationContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitRecordBodyDeclaration(JavaParser::RecordBodyDeclarationContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitPrefixExpression(JavaParser::PrefixExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitTypeExpression(JavaParser::TypeExpressionContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitBitwiseAndExpression(JavaParser::BitwiseAndExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitBitwiseXorExpression(JavaParser::BitwiseXorExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitBitwiseOrExpression(JavaParser::BitwiseOrExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLogicalAndExpression(JavaParser::LogicalAndExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLogicalOrExpression(JavaParser::LogicalOrExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitTernaryExpression(JavaParser::TernaryExpressionContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitExplicitGenericInvocationExpression(JavaParser::ExplicitGenericInvocationExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitThisExpression(JavaParser::ThisExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitMemberReferenceExpression(JavaParser::MemberReferenceExpressionContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitMethodReferenceExpression(JavaParser::MethodReferenceExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitParExpr(JavaParser::ParExprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLiteralExpression(JavaParser::LiteralExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitClassExpression(JavaParser::ClassExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitSuperExpression(JavaParser::SuperExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitArrayAccessExpression(JavaParser::ArrayAccessExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitIdentifierExpression(JavaParser::IdentifierExpressionContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitObjectCreator(JavaParser::ObjectCreatorContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitCoitDiamond(JavaParser::CoitDiamondContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitDimExpr(JavaParser::DimExprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitArrayCreator(JavaParser::ArrayCreatorContext *ctx) override {
    return visitChildren(ctx);
  }
